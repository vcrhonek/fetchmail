...
class User(object):
    def __init__(self):
        ...
        self.passwordeval = None	# Password-yielding command to run
        ...
        self.sslprotocolversion = None	# Force SSL?
        ...
        self.sslmode = None	# SSL operation mode (none/wrapped/starttls)
    ...
    def __repr__(self):
        ...
        if self.sslmode and self.sslmode != UserDefaults.sslmode:
            res = res + " sslmode " + repr(self.sslmode)
        if self.sslprotocolversion and self.sslprotocolversion != UserDefaults.sslprotocolversion:
            res = res + " sslproto " + repr(self.sslprotocolversion)
        ...
        if self.passwordeval:
            res += res + "passwordeval " + repr(self.passwordeval) + " "
        res = res + "\n"
...
# present in the dictionary.
    optional = ('interface', 'monitor',
                ...
                'ssl', 'sslkey', 'sslcert', 'sslmode', 'sslprotocolversion', 'sslcertck',
